...
if (Length > 0) {
    ...
    while (aimed("false") & bucle(X) & (X < Length)) {
		...
		// Coge de la lista FOVObjects el elemento nº X y lo pone en Object
        ...
        if (Type > 1000) {
            ...
            if (Team == 200) {  // If he is an enemy...
				...
				-+aimed("true");
				-+bucle2(0);
				while (aimed("true") & bucle(Y) & (Y < Length)) {
					// Coge de la lista FOVObjects el elemento nº Y y lo pone en Object2
					...
					if(Distance>Distance2 & Angle==Angle2) {
						-+aimed("false");
					}
					-+bucle2(Y+1);
				}
